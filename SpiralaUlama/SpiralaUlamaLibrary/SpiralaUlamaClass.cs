...
{
    public class SpiralaUlamaClass
    {
        ...
        ///inicjacja
        public SpiralaUlamaClass()
        {
            punkty = new List<Tuple<int, int>>();
            maximumValue = PrimeNumbersClass.GetSingleton().MaximumValue;
            primeList = PrimeNumbersClass.GetSingleton().ReturnPrimeNumbersTo(maximumValue);
        ...
        public Tuple<List<Tuple<int, int>>, double> GetValues(int maxHeight, int maxWidth)
        {
            ...
            maxHeight -= 20;
            maxWidth -= 20;
            double ratioX = ((double)maxWidth) / ((double)(2+maxx - minx));
            double ratioY = ((double)maxHeight) / ((double)(2+maxy - miny));
